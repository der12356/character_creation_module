...
def attack(char_name: str, char_class: str) -> str:
    """Считает урон атакой в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Считает заблокированный урон в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяет спец умения класса персонажа."""
    if char_class == 'warrior':
